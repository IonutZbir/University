...
% CORREZIONE QUI: Separati per chiarezza e aggiunta opzione version=4
\usepackage{siunitx}
\usepackage{physics}
\usepackage[version=4]{mhchem} 
\usepackage{cancel}

% CORREZIONE QUI: Risoluzione conflitto siunitx/physics
% Ora \qty serve per le unità di misura (es. \qty{10}{m})
...
\title{Appunti di Algorithmic Game Teory}
