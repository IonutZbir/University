...
\textbf{Osservazione:} Il tempo di convergenza è logaritmico rispetto a $n$ e $\mathcal{M}$, e inversamente proporzionale a $\log(1/\lambda)$, quindi nella dimensione del grafo e nella massa totale (\textbf{molto buono!}), mentre è inversamente proporzionale alla distanza tra 1 e il secondo autovalore $\lambda$ (cioè salla \textbf{spectral gap} topologia del del grafo).
\begin{itemize}
